...
🌐 語言切換：**繁體中文** | [English](./README.en.md)
...
本專案歡迎各種形式的改作與優化。根據 Apache 2.0 條款，修改後的版本必須標註變更說明。原作者希望能與社群保持良好溝通，若您有意進行大幅度修改或建立分支 (Fork)，請在修改前先透過任一 [社群連結](https://natsumes.cc/about) 與我聯繫告知，萬分感謝。
